#include "RTXRayTracingMeshDemo.h"
...
RTXRayTracingMeshDemo::RTXRayTracingMeshDemo(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) :
...
RTXRayTracingMeshDemo::~RTXRayTracingMeshDemo()
{

}
bool RTXRayTracingMeshDemo::Init()
{
	ModuleBase::Setup();
	ModuleBase::Prepare();
...
void RTXRayTracingMeshDemo::Exist()
{
	DestroyAssets();
	DestroyGUI();
	ModuleBase::Release();
...
void RTXRayTracingMeshDemo::Loop(float time,float delta)
{
	if(!m_Ready)
	{
		return;
...
void RTXRayTracingMeshDemo::Draw(float time,float delta)
{
...
bool RTXRayTracingMeshDemo::UpdateUI(float time,float delta)
{
	m_GUI->StartFrame();
...
void RTXRayTracingMeshDemo::UpdateUniformBuffer()
{
...
void RTXRayTracingMeshDemo::PrepareDescriptorSets()
{
...
void RTXRayTracingMeshDemo::PrepareShaderBindingTab()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMeshDemo::PrepareRayTracingPipeline()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
	...
	auto rayGenShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/63_RTXRayTracingMesh/raygen.rgen.spv",VK_SHADER_STAGE_RAYGEN_BIT_NV);
	auto rayMisShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/63_RTXRayTracingMesh/miss.rmiss.spv",VK_SHADER_STAGE_MISS_BIT_NV);
	auto rayHitShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/63_RTXRayTracingMesh/closesthit.rchit.spv",VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV);
...
void RTXRayTracingMeshDemo::PrepareUniformBuffers()
{
...
void RTXRayTracingMeshDemo::LoadTextures(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMeshDemo::LoadMaterials(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMeshDemo::LoadMeshes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMeshDemo::LoadNode(Node* parent,tinygltf::Node& gltfNode,tinygltf::Model& gltfModel)
{
	Node* node = new Node();
...
void RTXRayTracingMeshDemo::LoadNodes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMeshDemo::LoadGLTFModel(DVKCommandBuffer* cmdBuffer)
{
...
void RTXRayTracingMeshDemo::LoadAssets()
{
...
void RTXRayTracingMeshDemo::LoadExtensions()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMeshDemo::PrepareAS()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMeshDemo::CreateTopLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMeshDemo::CreateBottomLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMeshDemo::DestroyAssets()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMeshDemo::SetupGfxCommand(int32 backBufferIndex)
{
...
void RTXRayTracingMeshDemo::CreateGUI()
{
	m_GUI = new ImageGUIContext();
	m_GUI->Init("Assets/fonts/Ubuntu-Regular.ttf");
}

void RTXRayTracingMeshDemo::DestroyGUI()
{
	m_GUI->Destroy();
	delete m_GUI;
}