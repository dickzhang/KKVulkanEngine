#include "RTXRayTracingSimpleDemo.h"
...
RTXRayTracingSimpleDemo::RTXRayTracingSimpleDemo(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) :
...
RTXRayTracingSimpleDemo::~RTXRayTracingSimpleDemo()
{

}
bool RTXRayTracingSimpleDemo::Init()
{
	ModuleBase::Setup();
	ModuleBase::Prepare();
...
void RTXRayTracingSimpleDemo::Exist()
{
	DestroyAssets();
	DestroyGUI();
	ModuleBase::Release();
...
void RTXRayTracingSimpleDemo::Loop(float time,float delta)
{
	if(!m_Ready)
	{
		return;
...
void RTXRayTracingSimpleDemo::Draw(float time,float delta)
{
...
bool RTXRayTracingSimpleDemo::UpdateUI(float time,float delta)
{
	m_GUI->StartFrame();
...
void RTXRayTracingSimpleDemo::UpdateUniformBuffer()
{
...
void RTXRayTracingSimpleDemo::PrepareDescriptorSets()
{
...
void RTXRayTracingSimpleDemo::PrepareShaderBindingTab()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingSimpleDemo::PrepareRayTracingPipeline()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
	...
	auto rayGenShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/64_RTXRayTracingSimple/raygen.rgen.spv",VK_SHADER_STAGE_RAYGEN_BIT_NV);
	auto rayMisShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/64_RTXRayTracingSimple/miss.rmiss.spv",VK_SHADER_STAGE_MISS_BIT_NV);
	auto rayHitShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/64_RTXRayTracingSimple/closesthit.rchit.spv",VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV);
...
void RTXRayTracingSimpleDemo::PrepareUniformBuffers()
{
...
void RTXRayTracingSimpleDemo::LoadTextures(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingSimpleDemo::LoadMaterials(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingSimpleDemo::LoadMeshes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingSimpleDemo::LoadNode(Node* parent,tinygltf::Node& gltfNode,tinygltf::Model& gltfModel)
{
	Node* node = new Node();
...
void RTXRayTracingSimpleDemo::LoadNodes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingSimpleDemo::LoadGLTFModel(DVKCommandBuffer* cmdBuffer)
{
...
void RTXRayTracingSimpleDemo::LoadAssets()
{
...
void RTXRayTracingSimpleDemo::LoadExtensions()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingSimpleDemo::PrepareAS()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingSimpleDemo::CreateTopLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingSimpleDemo::CreateBottomLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingSimpleDemo::DestroyAssets()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingSimpleDemo::SetupGfxCommand(int32 backBufferIndex)
{
...
void RTXRayTracingSimpleDemo::CreateGUI()
{
	m_GUI = new ImageGUIContext();
	m_GUI->Init("Assets/fonts/Ubuntu-Regular.ttf");
}

void RTXRayTracingSimpleDemo::DestroyGUI()
{
	m_GUI->Destroy();
	delete m_GUI;
}