...
class RTXPathTracingDemo :public ModuleBase
{
public:
    ...
    void LoadLights(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel);
...
private:
    ...
    Scene                                               m_Scene;
    DVKBuffer* m_LightsBuffer = nullptr;
    DVKBuffer* m_MaterialsBuffer = nullptr;
    DVKBuffer* m_ObjectsBuffer = nullptr;
    DVKBuffer* m_ObjectsBoundsBuffer = nullptr;
    DVKBuffer* m_ObjectsTransformBuffer = nullptr;
