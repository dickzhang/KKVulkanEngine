#include "RTXRayTracingReflectionDemo.h"
...
RTXRayTracingReflectionDemo::RTXRayTracingReflectionDemo(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) :
...
RTXRayTracingReflectionDemo::~RTXRayTracingReflectionDemo()
{

}
bool RTXRayTracingReflectionDemo::Init()
{
	ModuleBase::Setup();
	ModuleBase::Prepare();
...
void RTXRayTracingReflectionDemo::Exist()
{
	DestroyAssets();
	DestroyGUI();
	ModuleBase::Release();
...
void RTXRayTracingReflectionDemo::Loop(float time,float delta)
{
	if(!m_Ready)
	{
		return;
...
void RTXRayTracingReflectionDemo::Draw(float time,float delta)
{
...
bool RTXRayTracingReflectionDemo::UpdateUI(float time,float delta)
{
	m_GUI->StartFrame();
...
void RTXRayTracingReflectionDemo::UpdateUniformBuffer()
{
...
void RTXRayTracingReflectionDemo::PrepareDescriptorSets()
{
...
void RTXRayTracingReflectionDemo::PrepareShaderBindingTab()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingReflectionDemo::PrepareRayTracingPipeline()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
	...
	auto rayGenShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/65_RTXRayTracingReflection/raygen.rgen.spv",VK_SHADER_STAGE_RAYGEN_BIT_NV);
	auto rayMisShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/65_RTXRayTracingReflection/miss.rmiss.spv",VK_SHADER_STAGE_MISS_BIT_NV);
	auto rayHitShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/65_RTXRayTracingReflection/closesthit.rchit.spv",VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV);
...
void RTXRayTracingReflectionDemo::PrepareUniformBuffers()
{
...
void RTXRayTracingReflectionDemo::LoadTextures(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingReflectionDemo::LoadMaterials(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingReflectionDemo::LoadMeshes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingReflectionDemo::LoadNode(Node* parent,tinygltf::Node& gltfNode,tinygltf::Model& gltfModel)
{
	Node* node = new Node();
...
void RTXRayTracingReflectionDemo::LoadNodes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingReflectionDemo::LoadGLTFModel(DVKCommandBuffer* cmdBuffer)
{
...
void RTXRayTracingReflectionDemo::LoadAssets()
{
...
void RTXRayTracingReflectionDemo::LoadExtensions()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingReflectionDemo::PrepareAS()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingReflectionDemo::CreateTopLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingReflectionDemo::CreateBottomLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingReflectionDemo::DestroyAssets()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingReflectionDemo::SetupGfxCommand(int32 backBufferIndex)
{
...
void RTXRayTracingReflectionDemo::CreateGUI()
{
	m_GUI = new ImageGUIContext();
	m_GUI->Init("Assets/fonts/Ubuntu-Regular.ttf");
}

void RTXRayTracingReflectionDemo::DestroyGUI()
{
	m_GUI->Destroy();
	delete m_GUI;
}