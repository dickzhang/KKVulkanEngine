#include "GeometryOmniShadowDemo.h"
...
GeometryOmniShadowDemo::GeometryOmniShadowDemo(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) :
	ModuleBase(width,height,title,cmdLine)
{
}

GeometryOmniShadowDemo::~GeometryOmniShadowDemo()
{

}

bool GeometryOmniShadowDemo::Init()
{
	ModuleBase::Setup();
	ModuleBase::Prepare();
...
void GeometryOmniShadowDemo::Exist()
{
	ModuleBase::Release();
...
void GeometryOmniShadowDemo::Loop(float time,float delta)
{
	if(!m_Ready)
	{
		return;
...
void GeometryOmniShadowDemo::Draw(float time,float delta)
{
...
void GeometryOmniShadowDemo::UpdateUI(float time,float delta)
{
	m_GUI->StartFrame();
...
void GeometryOmniShadowDemo::CreateRenderTarget()
{
...
void GeometryOmniShadowDemo::DestroyRenderTarget()
{
	delete m_ShadowRTT;
	delete m_RTColor;
	delete m_RTDepth;
...
void GeometryOmniShadowDemo::LoadAssets()
{
...
void GeometryOmniShadowDemo::DestroyAssets()
{
	delete m_ModelScene;
...
void GeometryOmniShadowDemo::SetupCommandBuffers(int32 backBufferIndex)
{
	VkViewport viewport = { };
	viewport.x = 0;
...
void GeometryOmniShadowDemo::InitParmas()
{
...
void GeometryOmniShadowDemo::CreateGUI()
{
	m_GUI = new ImageGUIContext();
	m_GUI->Init("Assets/fonts/Ubuntu-Regular.ttf");
}

void GeometryOmniShadowDemo::DestroyGUI()
{
	m_GUI->Destroy();
	delete m_GUI;
}