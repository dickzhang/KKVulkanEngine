...
TriangleModule::TriangleModule(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) : AppModuleBase(width,height,title)
{
...
VkShaderModule TriangleModule::LoadSPIPVShader(const std::string& filepath)
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void TriangleModule::CreateFrameBuffers()
{
	DestroyFrameBuffers();
...
void TriangleModule::CreateDepthStencil()
{
	DestoryDepthStencil();
...
void TriangleModule::CreateRenderPass()
{
	DestoryRenderPass();
...
void TriangleModule::DestroyFrameBuffers()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void TriangleModule::DestoryRenderPass()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void TriangleModule::DestoryDepthStencil()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void TriangleModule::DestroyCommandBuffers()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
	for(int32 i = 0; i<m_CommandBuffers.size(); ++i)
	{
...
void TriangleModule::CreateCommandBuffers()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void TriangleModule::CreateSemaphores()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void TriangleModule::DestorySemaphores()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
	vkDestroySemaphore(device,m_RenderComplete,VULKAN_CPU_ALLOCATOR);
}

void TriangleModule::CreateFences()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void TriangleModule::DestroyFences()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
	for(int32 i = 0; i<m_Fences.size(); ++i)
	{
