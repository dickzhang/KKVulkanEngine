...
EdgeDetectDemo::EdgeDetectDemo(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) :
...
bool EdgeDetectDemo::PreInit()
{
	return true;
}

bool EdgeDetectDemo::Init()
{
	ModuleBase::Setup();
	ModuleBase::Prepare();
...
void EdgeDetectDemo::Loop(float time,float delta)
{
	if(!m_Ready)
	{
		return;
...
void EdgeDetectDemo::Draw(float time,float delta)
{
...
bool EdgeDetectDemo::UpdateUI(float time,float delta)
{
	m_GUI->StartFrame();
...
void EdgeDetectDemo::CreateRenderTarget()
{
	...
	m_RTNormal = DVKTexture::CreateRenderTarget(
		m_VulkanDevice,
...
void EdgeDetectDemo::DestroyRenderTarget()
{
	delete m_RenderTarget;
}

void EdgeDetectDemo::LoadAssets()
{
...
void EdgeDetectDemo::DestroyAssets()
{
...
void EdgeDetectDemo::SetupCommandBuffers(int32 backBufferIndex)
{
	VkViewport viewport = { };
	viewport.x = 0;
...
void EdgeDetectDemo::InitParmas()
{
...
void EdgeDetectDemo::CreateGUI()
{
	m_GUI = new ImageGUIContext();
	m_GUI->Init("Assets/fonts/Ubuntu-Regular.ttf");
}

void EdgeDetectDemo::DestroyGUI()
{
	m_GUI->Destroy();
	delete m_GUI;
}