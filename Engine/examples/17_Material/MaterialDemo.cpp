...
MaterialDemo::MaterialDemo(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) :
...
bool MaterialDemo::PreInit()
{
	return true;
}

bool MaterialDemo::Init()
{
	ModuleBase::Setup();
	ModuleBase::Prepare();
...
void MaterialDemo::Loop(float time,float delta)
{
	if(!m_Ready)
	{
		return;
...
void MaterialDemo::CreateFrameBuffers()
{
	DestroyFrameBuffers();
...
void MaterialDemo::CreateDepthStencil()
{

}

void MaterialDemo::DestoryDepthStencil()
{

}

void MaterialDemo::DestroyAttachments()
{
...
void MaterialDemo::CreateAttachments()
{
...
void MaterialDemo::CreateRenderPass()
{
	DestoryRenderPass();
	DestroyAttachments();
	CreateAttachments();
...
void MaterialDemo::DestroyFrameBuffers()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void MaterialDemo::DestoryRenderPass()
{
	VkDevice device = GetVulkanRHI()->GetDevice()->GetInstanceHandle();
...
void MaterialDemo::Draw(float time,float delta)
{
...
void MaterialDemo::UpdateUniform(float time,float delta)
{
...
bool MaterialDemo::UpdateUI(float time,float delta)
{
	m_GUI->StartFrame();
...
void MaterialDemo::LoadAssets()
{
	// shader0
	m_Shader0 = DVKShader::Create(
		m_VulkanDevice,
		true,
		"Assets/Shaders/17_Material/obj.vert.spv",
		"Assets/Shaders/17_Material/obj.frag.spv"
	);
	...
	// 设置gbuffer material
	m_Material0 = DVKMaterial::Create(
		m_VulkanDevice,
		m_RenderPass,
		m_PipelineCache,
		m_Shader0
	...
	m_Shader1 = DVKShader::Create(
		m_VulkanDevice,
		true,
		"Assets/Shaders/17_Material/quad.vert.spv",
		"Assets/Shaders/17_Material/quad.frag.spv"
	);
	// 设置deferred material
	m_Material1 = DVKMaterial::Create(
		m_VulkanDevice,
		m_RenderPass,
		m_PipelineCache,
		m_Shader1
...
void MaterialDemo::DestroyAssets()
{
	delete m_Model;
...
void MaterialDemo::SetupCommandBuffers(int32 backBufferIndex)
{
...
void MaterialDemo::CreateGUI()
{
	m_GUI = new ImageGUIContext();
	m_GUI->Init("Assets/fonts/Ubuntu-Regular.ttf");
}

void MaterialDemo::DestroyGUI()
{
	m_GUI->Destroy();
	delete m_GUI;
}