#include "RTXRayTracingMonteCarloDemo.h"
...
RTXRayTracingMonteCarloDemo::RTXRayTracingMonteCarloDemo(int32 width,int32 height,const char* title,const std::vector<std::string>& cmdLine) :
...
RTXRayTracingMonteCarloDemo::~RTXRayTracingMonteCarloDemo()
{

}

bool RTXRayTracingMonteCarloDemo::Init()
{
	ModuleBase::Setup();
	ModuleBase::Prepare();
...
void RTXRayTracingMonteCarloDemo::Exist()
{
	DestroyAssets();
	DestroyGUI();
	ModuleBase::Release();
...
void RTXRayTracingMonteCarloDemo::Loop(float time,float delta)
{
	if(!m_Ready)
	{
		return;
...
void RTXRayTracingMonteCarloDemo::Draw(float time,float delta)
{
...
bool RTXRayTracingMonteCarloDemo::UpdateUI(float time,float delta)
{
	m_GUI->StartFrame();
...
void RTXRayTracingMonteCarloDemo::UpdateUniformBuffer()
{
...
void RTXRayTracingMonteCarloDemo::PrepareDescriptorSets()
{
...
void RTXRayTracingMonteCarloDemo::PrepareShaderBindingTab()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMonteCarloDemo::PrepareRayTracingPipeline()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
	...
	auto rayGenShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/67_RTXRayTracingMonteCarlo/raygen.rgen.spv",VK_SHADER_STAGE_RAYGEN_BIT_NV);
	auto rayMisShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/67_RTXRayTracingMonteCarlo/miss.rmiss.spv",VK_SHADER_STAGE_MISS_BIT_NV);
	auto rayHitShaderModule = DVKShaderModule::Create(m_VulkanDevice,"Assets/Shaders/67_RTXRayTracingMonteCarlo/closesthit.rchit.spv",VK_SHADER_STAGE_CLOSEST_HIT_BIT_NV);
...
void RTXRayTracingMonteCarloDemo::PrepareUniformBuffers()
{
...
void RTXRayTracingMonteCarloDemo::LoadTextures(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMonteCarloDemo::LoadMaterials(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMonteCarloDemo::LoadMeshes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMonteCarloDemo::LoadNode(Node* parent,tinygltf::Node& gltfNode,tinygltf::Model& gltfModel)
{
	Node* node = new Node();
...
void RTXRayTracingMonteCarloDemo::LoadNodes(DVKCommandBuffer* cmdBuffer,tinygltf::Model& gltfModel)
{
...
void RTXRayTracingMonteCarloDemo::LoadGLTFModel(DVKCommandBuffer* cmdBuffer)
{
...
void RTXRayTracingMonteCarloDemo::LoadAssets()
{
...
void RTXRayTracingMonteCarloDemo::LoadExtensions()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMonteCarloDemo::PrepareAS()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMonteCarloDemo::CreateTopLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMonteCarloDemo::CreateBottomLevelAS(DVKCommandBuffer* cmdBuffer)
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMonteCarloDemo::DestroyAssets()
{
	VkDevice device = m_VulkanDevice->GetInstanceHandle();
...
void RTXRayTracingMonteCarloDemo::SetupGfxCommand(int32 backBufferIndex)
{
...
void RTXRayTracingMonteCarloDemo::CreateGUI()
{
	m_GUI = new ImageGUIContext();
	m_GUI->Init("Assets/fonts/Ubuntu-Regular.ttf");
}

void RTXRayTracingMonteCarloDemo::DestroyGUI()
{
	m_GUI->Destroy();
	delete m_GUI;
}
